...
*************************************************************************
* Add states and district information to data (start at year 2000)
*************************************************************************

* 1999-2000
use $ASIpaneldir/2000/A_CrossSection.dta
rename *, lower
rename a_itm7 state
rename a_itm8 district
rename wgt Multiple
rename e_itm11 CostProduction
rename e_itm10 Days
rename a_itm5 IndCodeReturn
rename a_itm9 AreaCode
keep state district Multiple CostProduction Days IndCodeReturn AreaCode dsl 
merge m:m Multiple CostProduction Days IndCodeReturn AreaCode using $ASIpaneldir/temp/2000A.dta

foreach j in 1999/2016 {
	use $ASIpaneldir/`j'/A_
}
