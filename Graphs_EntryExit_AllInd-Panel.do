...
foreach fuel in coal oil gas otherf {
	gen s_`fuel' = `fuel'/fuels
	bysort IndCodeReturn year: egen s_`fuel'_indavg = mean(s_`fuel')
...
preserve
	...
	graph export Output/Graphs/EntryExit/RelCoalShare_year-Allind.pdf, replace
	...
	graph export Output/Graphs/EntryExit/RelGasShare_year-Allind.pdf, replace
	...
	graph export Output/Graphs/EntryExit/RelOilShare_year-Allind.pdf, replace
	...
	graph export Output/Graphs/EntryExit/RelOtherfShare_year-Allind.pdf, replace
restore
...
preserve
	...
	graph export Output/Graphs/EntryExit/EnergyConsumption_year-Allind.pdf, replace
	...
	graph export Output/Graphs/EntryExit/GHGEmission_year-Allind.pdf, replace
restore
