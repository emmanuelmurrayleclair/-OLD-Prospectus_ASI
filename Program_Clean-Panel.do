...
**** This file cleans and prepares the panel ASI data
...
replace k1 = 866 if (StateCode == 35) | (a7 == 19) // Kolkata
replace k1 = 822 if (StateCode == 28) | (a7 == 36) // Hyderabad
replace k1 = 750 if (StateCode == 6) | (a7 == 4) | (a7 == 3) // Punjab and Haryana
replace k1 = 723 if StateCode == 16 // Tripura
replace k1 = 711 if (StateCode == 32) | (a7 == 31) // Kerala
...
save Panel_Data/Clean_data/ASI_PanelCleanFinal, replace
